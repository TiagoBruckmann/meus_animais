...
mixin _$RegisterMobx on _RegisterMobx, Store {
  final _$controllerNameAtom = Atom(name: '_RegisterMobx.controllerName');
  ...
  final _$controllerEmailAtom = Atom(name: '_RegisterMobx.controllerEmail');
  ...
  final _$controllerPasswdAtom = Atom(name: '_RegisterMobx.controllerPasswd');
  ...
  final _$messageAtom = Atom(name: '_RegisterMobx.message');
  ...
  final _$passwdVisibleAtom = Atom(name: '_RegisterMobx.passwdVisible');
  ...
  final _$darkThemeAtom = Atom(name: '_RegisterMobx.darkTheme');
  ...
  final _$_RegisterMobxActionController =
      ActionController(name: '_RegisterMobx');
