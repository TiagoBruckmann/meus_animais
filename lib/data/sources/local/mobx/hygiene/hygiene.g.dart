...
mixin _$HygieneMobx on _HygieneMobx, Store {
  final _$nameAtom = Atom(name: '_HygieneMobx.name');
  ...
  final _$controllerPlaceAtom = Atom(name: '_HygieneMobx.controllerPlace');
  ...
  final _$controllerDayAtom = Atom(name: '_HygieneMobx.controllerDay');
  ...
  final _$controllerValueAtom = Atom(name: '_HygieneMobx.controllerValue');
  ...
  final _$_HygieneMobxActionController = ActionController(name: '_HygieneMobx');
