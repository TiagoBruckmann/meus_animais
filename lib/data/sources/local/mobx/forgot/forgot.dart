...
import 'package:meus_pets/data/sources/local/manager/forgot.dart';
...
class ForgotMobx = _ForgotMobx with _$ForgotMobx;
...
abstract class _ForgotMobx with Store {
  ...
  validateEmail( context ) async {
    analytics.logEvent(name: "validate_email-v1");
