...
mixin _$PetsMobx on _PetsMobx, Store {
  final _$getPetsAsyncAction = AsyncAction('_PetsMobx.getPets');
  ...
  final _$refreshAsyncAction = AsyncAction('_PetsMobx.refresh');
  ...
  final _$_PetsMobxActionController = ActionController(name: '_PetsMobx');
