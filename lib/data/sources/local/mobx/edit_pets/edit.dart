...
// gerencia de estado
import 'package:meus_pets/data/sources/local/manager/get_hygiene_pets.dart';
import 'package:meus_pets/data/sources/local/manager/get_vaccines.dart';
...
class EditMobx = _EditMobx with _$EditMobx;
...
abstract class _EditMobx with Store {
  ...
  validateFields( context ) async {
    ...
    analytics.logEvent(name: "validate_update_pet-v1");
