...
import 'package:meus_pets/data/sources/local/manager/set_pet.dart';
...
class CreateMobx = _CreateMobx with _$CreateMobx;
...
abstract class _CreateMobx with Store {
  ...
  @action
  validateFields( String petId, File picture, context ) async {

    analytics.logEvent(name: "validate_pet-v1");
