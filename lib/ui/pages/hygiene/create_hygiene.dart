...
import 'package:meus_pets/data/sources/local/manager/get_hygiene.dart';
...
import 'package:meus_pets/data/sources/local/mobx/hygiene/hygiene.dart';

class CreateHygiene extends StatefulWidget {

  final String petId;
  final bool update;
  CreateHygiene({ Key key, @required this.petId, @required this.update }) : super(key: key);
